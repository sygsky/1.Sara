...
SYG_getVehicleType1 = {
    ...
    if ( _this isKindOf "Helicopter" ) exitWith { 3 };
...
SYG_getVehicleType = {
	...
	hint localize format["+++ SYG_getVehicleType: _this = %1", _entry];
	//_typeCfg = configFile >> _entry >> "Library" >> "type";
	_entry = configFile >> "CfgVehicles" >>_entry;
	_typeCfg = _entry >> "Library" >> "type";
	_typeNr = -1;
...
SYG_addEventsAndDispose = {
	hint localize "*** SYG_addEventsAndDispose: is dummy here!!!";
};
