/*
    scripts\bonuses\getin_2.sqf : secondary getin event for light version of bunus vehicle creation on island territory not the base only
	author: Sygsky
...
//+++++++++++++++++
_veh = _this select 0;
if ( isNull _veh ) exitWith { hint localize "--- getin_2.sqf: isNull vehicle detected, exit script"; }; // that is an empty call __FILE__
...
_player = "";
if( isPlayer _unit ) then {_player = name _unit; };
